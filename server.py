...
class User:
    ...
    def __str__(self):
        return (self.nom)
users = [
    User(username= "aaparicio", nom="Alan Aparicio", password="12345", email="alanA@gmail.com", rol="tutor"),
...
def user():
    ...
    # Anar al DAO Server i cercar User per Username
        ...
        if response == None:
            ...
            resposta = {"username": response['username'], "nom": response['nom'], "email": response['email'], "rol": response['rol']}
